...
class Generalization extends Component {
    ...
    <Form  handleChange={this.handleChange} placeholder={this.state.placeholder} nameInput='اضافة '
      handleSubmit={this.handleSubmit} value={this.state.valueDescription} label='التعميم'  labelTitel='عنوان  التعميم' valueTitel={this.state.valueTitel} nameTitel="valueTitel"  url={this.state.url} handleChangeFile={this.handleChangeFile} name="valueDescription"  handleUpload ={this.handleUpload }/>
            {this.state.show &&
      <SweetAlert
        show={this.state.show}
        title="تعاميم"
        text="تم اضافة التعميم"
